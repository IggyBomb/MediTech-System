...
import controllerConsultatonsMedecin.InsertConsultationControllerMed;
...
public class InsertConsultationMed extends JFrame {
	...
	private InsertConsultationControllerMed controller;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					InsertConsultationMed frame = new InsertConsultationMed();
	 ...
	 * Create the frame.
	 */
	public InsertConsultationMed() {
		controller = new InsertConsultationControllerMed(this);
