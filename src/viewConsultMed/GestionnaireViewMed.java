...
public class GestionnaireViewMed extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GestionnaireViewMed frame = new GestionnaireViewMed();
	 ...
	 * Create the frame.
	 */
	public GestionnaireViewMed() {
		controller = new controllerGestConsultMed(this);
		...
		btnSearchConsultationID_clinical.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ConsultMedView.main(textField_idConsultClinical.getText());
			}
		});
		...
		btnNewConsult.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				InsertConsultationMed.main(null);
			}
		});
