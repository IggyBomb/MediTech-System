...
public class InsertConsultation extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InsertConsultation frame = new InsertConsultation();
	...
	public void fillComboPhysician() throws SQLException {
		try {
			...
			Logger.getLogger(InsertConsultation.class.getName());
		}/* finally {
	        pstmt.close();
	        rs.close();
	    }
